...
//  TONY  private static final int MSG_UPDATE_PANORAMA_UI = 16;
...
//    private boolean mShowDetails;
    ...
    // TONY private SecureAlbum mSecureAlbum;
...
//        mActionBar = mActivity.getGalleryActionBar();
        mSelectionManager = new SelectionManager(mActivity);
//        mMenuExecutor = new MenuExecutor(mActivity, mSelectionManager);

        mPhotoView = new PhotoView(mActivity);
//        mPhotoView.setSwipingEnabled(false);
...
//                            if (mAppBridge != null) mPhotoView.setFilmMode(false);
                        ...
                        if (stayedOnCamera) {
                            if (/*mAppBridge == null && */mMediaSet.getMediaItemCount() > 1) {
                                launchCamera();
...
//                        break;
//                    }
//     TONY               case MSG_UPDATE_PANORAMA_UI: {
//                        if (mCurrentPhoto == message.obj) {
//                            boolean isPanorama360 = message.arg1 != 0;
...
//        setupNfcBeamPush();
        ...
        if (mSetPathString != null) {
            ...
            mMediaSet = mActivity.getDataManager()
                    .getMediaSet(mSetPathString);
            if (mMediaSet == null) {
...
//            mShowSpinner = false;
            throw new IllegalStateException("SinglePhotoDataAdapter missing");
        }

        mPhotoView.setFilmMode(false/*mStartInFilmstrip && mMediaSet.getMediaItemCount() > 1*/);
        RelativeLayout galleryRoot = (RelativeLayout) ((Activity) mActivity)
                .findViewById(/*mAppBridge != null ? R.id.content : */R.id.gallery_root);
        if (galleryRoot != null) {
            //TONY if (mSecureAlbum == null) {
...
//            hideDetails();
//        } else
            if (/*mAppBridge == null*/ true /*|| !switchWithCaptureAnimation(-1)*/) {
...
//            data.putBoolean(PhotoPage.KEY_APP_BRIDGE, false/*mAppBridge != null*/);
...
//                activity.startActivityForResult(intent, false /* TONY PicasaSource.isPicasaImage(current)*/
//                        ? REQUEST_CROP_PICASA
//                        : REQUEST_CROP);
//                return true;
//            }
//            case R.id.action_trim: {
//    TONY            Intent intent = new Intent(mActivity, TrimVideo.class);
...
//     TONY           MuteVideo muteVideo = new MuteVideo(current.getFilePath(),
//                        manager.getContentUri(path), mActivity);
//                muteVideo.muteInBackground();
//                return true;
//            }
//            case R.id.action_edit: {
//                // TONY launchPhotoEditor();
//                return true;
//            }
//            case R.id.action_simple_edit: {
//                // TONY launchSimpleEditor();
//                return true;
//            }
...
//            }
//            case R.id.print: {
                // TONY mActivity.printSelectedImage(manager.getContentUri(path));
//                return true;
//            }
...
//                }
        ...
        if (albumPageTransition == MSG_ALBUMPAGE_RESUMED) {
            mPhotoView.setFilmMode(false/*mStartInFilmstrip || mAppBridge != null*/);
...
//                (/*TONY(mSecureAlbum == null) &&*/ (mSetPathString != null)), false);
...
//        } else {
//            // TONY currentPhoto.getPanoramaSupport(mRefreshBottomControlsCallback);
//        }
//    }

//  TONY  private void updatePanoramaUI(boolean isPanorama360) {
